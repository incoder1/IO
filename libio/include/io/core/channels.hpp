...
public:
	...
	virtual void recaive(std::error_code& ec, byte_buffer&& to,std::size_t position) const noexcept = 0;
...
/// channel, or an output error e.g no more disk space, socket connection interupted etc
/// \param ec operation error code, contains error when output error
