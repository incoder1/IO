/*
    ...
    OpenGL loader generated by glad 0.1.28 on Fri Jan 18 23:23:56 2019.
...
#define get_proc(__funct_name)  glfwGetProcAddress((__funct_name))
#define has_ext(__ext_name) glfwExtensionSupported((__ext_name))
...
GLAPI int gladLoadGL(void)
{
    ...
    GLADloadproc load = glfwGetProcAddress;

    glGetString = (PFNGLGETSTRINGPROC)glfwGetProcAddress("glGetString");
    if(NULL == glGetString)
        return 0;
    if(NULL == glGetString(GL_VERSION))
        return 0;
